    ...
    public static class CoreSeedData
    {
        public static void SeedData(ModelBuilder builder)
        {
            builder.Entity<Role>().HasData(
                new Role { Id = IdHelper.GenerateId("11111111-1111-1111-1111-111111111111"), Name = "systemadmin", NormalizedName = "SYSTEMADMIN", CreatedDate = DateTimeOffset.Now, CreatedBy = "systemadmin", UpdatedDate = DateTimeOffset.Now, UpdatedBy = "systemadmin" },
